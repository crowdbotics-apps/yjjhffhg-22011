"""yjjhffhg_22011 URL Configuration
...
admin.site.site_header = "yjjhffhg"
admin.site.site_title = "yjjhffhg Admin Portal"
admin.site.index_title = "yjjhffhg Admin"

# swagger
api_info = openapi.Info(
    title="yjjhffhg API",
    default_version="v1",
    description="API documentation for yjjhffhg App",
)
